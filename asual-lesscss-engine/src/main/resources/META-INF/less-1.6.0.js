...
less.Parser = function Parser(env) {
    ...
    function getInput(e, env) {
        // Original code
        // Causes "Cannot call method 'charAt' of undefined" errors in getLocation() when called from LessError()
...
//        }
        ...
        // Fixes "Cannot call method 'charAt' of undefined" errors in getLocation() when called from LessError()
        // From https://gist.github.com/exortech/2306083
        if (e.filename && env.filename && (e.filename !== env.filename)) {
            var baseFilename = basename(e.filename);
            for (var f in parser.imports.contents) {
